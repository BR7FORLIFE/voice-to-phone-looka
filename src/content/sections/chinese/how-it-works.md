...
list:
  - title: "第一步：【蓝图设计】制定利润目标"
    description: |
      <span class="text-accent text-lg font-semibold mb-2 block">核心动作：先算后做</span>
  ...
  - title: "第二步：【责任到人】拆解目标与KPI"
    description: |
      <span class="text-accent text-lg font-semibold mb-2 block">核心动作：千斤重担人人挑</span>
  ...
  - title: "第三步：【系统激励】绑定薪酬与奖励"
    description: |
      <span class="text-accent text-lg font-semibold mb-2 block">核心动作：为结果付薪</span>

      打造一个自动自发的"赚钱"团队，关键在于"分钱的艺术"。我们帮您设计一套透明、公平、且极具煽动性的薪酬奖励系统，将个人和团队的收入与KPI完成度强力挂钩。员工不再是为老板打工，而是为自己的钱包而战。
    images:
      src:
  ...
  - title: "第四步：【循环优化】复盘与调整"
    description: |
      <span class="text-accent text-lg font-semibold mb-2 block">核心动作：持续迭代</span>
